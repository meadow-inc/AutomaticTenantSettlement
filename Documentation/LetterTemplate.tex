...
\begin{letter}{
\textbf{Empfänger:} \\
tenant_vorname tenant_nachname
}
...
Sehr geehrter tenant_vorname tenant_lastname,
...
\ifthenelse{\debtAmount > 0}{
    \ifthenelse{\debtAmount < 5}{
        ...
        Aus dieser ergibt sich eine Nachzahlung in Höhe von \debtAmount Euro. Ich bitte um eine Überweisung bis zum <pay_date> auf folgendes Bankkonto:
...
\newpage
\Placeholder{billTablePlaceholder} % Placeholder for the table string generated in your BillProcessor class
